...
/**
 * This interface encapsules all methods regarding {@link Sector} related
 * operations.
 * 
 * @author fred
 * 
...
public interface SectorService extends EntityService<Sector> {
	 ...
	 * 
	 * @return A list of suggestions what to enter inside an input field 
	 */
