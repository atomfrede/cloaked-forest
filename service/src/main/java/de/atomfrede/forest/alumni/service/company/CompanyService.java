...
public interface CompanyService extends EntityService<Company> {
	 ...
	 * 
	 * Throws a {@link CompanyAlreadyExistingException} if a company with the
	...
	/**
	 * Checks if for the company with the given name a department with the given
	 * name already exists.
	 * 
	 * @param company
	 *            name of the company.
	 ...
	 * @return true iff the company has already a department with the given
	 *         name.
	 */
	boolean departmentAlreadyExisting(String company, String department);

	/**
	 * Retrieves a subset of companies, ordered by the given order property that
	 * belong to the given sector.
	 * 
	 * @param offset
	 * @param count
	 * @param orderProperty
	 *            property the result should be ordered by, e.g. the company
	 *            name.
	 * @param desc
	 *            flag indicating the order direction.
	 * @param sectorId
	 *            the ID of the sector the retrieved companies should belong to.
	 * @return
	 */
	List<Company> list(long offset, long count, String orderProperty,
